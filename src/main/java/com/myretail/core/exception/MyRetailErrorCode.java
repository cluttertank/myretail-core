...
public enum MyRetailErrorCode {
    ...
    private MyRetailErrorCode() {
    }

    public static MyRetailErrorCode fromString(String codeStr) {
        if (codeStr != null) {
            for (MyRetailErrorCode customErrorCode : MyRetailErrorCode.values()) {
